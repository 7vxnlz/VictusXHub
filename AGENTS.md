...
- Read `.github/ai/AI_WORKING_STATE.md`, then the nearest path `AGENTS.md` and one relevant context pack.
- References under `D:\Projects\Workspace\references\` are read-only. Use `docs/reference-index.md` and `docs/development/REFERENCE_POLICY.md` before reference research.
