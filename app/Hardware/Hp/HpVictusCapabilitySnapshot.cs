...
public sealed record HpVictusCapabilitySnapshot(
    ...
    string[] Errors)
{
    internal bool KeyboardStatusInvocationAllowed { get; init; }
    internal bool KeyboardStatusInvocationAttempted { get; init; }
    internal bool KeyboardStatusInvocationSucceeded { get; init; }
    internal int KeyboardStatusReturnedByteCount { get; init; }
    internal string KeyboardStatusInvocationError { get; init; } = string.Empty;
    internal HpKeyboardBacklightStatus KeyboardBacklightStatus { get; init; } = HpKeyboardBacklightStatus.Unavailable;
