...
| --- | --- | --- | --- |
| `THIRD-PARTY-NOTICES.md` release readiness | Blocked | Promote from source-assembled status only after external NvAPIWrapper layout verification and final artifact matching are complete. | [Third-Party Notices](../THIRD-PARTY-NOTICES.md), [Runtime dependency review](runtime-dependency-license-review.md) |
