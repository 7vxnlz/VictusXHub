...
| .NET runtime servicing baseline | Done for current source | The prior 10.0.10 `win-x64` runtime-pack baseline was superseded after servicing advisories. SDK 10.0.400 restored Microsoft.NETCore.App.Runtime.win-x64 and Microsoft.WindowsDesktop.App.Runtime.win-x64 at 10.0.11; the ignored local candidate passed automated inspection. Runtime notice mapping for 10.0.11 remains blocked. |
